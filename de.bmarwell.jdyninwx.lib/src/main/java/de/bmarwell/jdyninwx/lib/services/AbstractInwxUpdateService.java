...
abstract class AbstractInwxUpdateService implements InwxUpdateService {
    ...
    private InwxCredentials credentials;
    ...
    @Override
    public InwxUpdateService withDefaultTtl(Duration defaultTtl) {
    ...
    @Override
    public InwxUpdateService withCredentials(InwxCredentials credentials) {
